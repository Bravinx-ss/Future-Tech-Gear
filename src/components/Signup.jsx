...
const Signup = () => {
    ...
    const submit=async (e)=>{
        ...
        try {            
            ...
            const response=await axios.post("https://Bravinchui.pythonanywhere.com/api/signup",data)
            setLoading("")
            setError("")
        ...
        <hr />  */}
            <div className="col-md-6 card shadow p-4 text-center">
                ...
                <form onSubmit={submit}>
                    ...
                    <input type="text" placeholder="Enter Username" className="form-control" onChange={(e)=>setUsername(e.target.value)} value={username}  required/> <br />
                    {username}                    
