...
const Makepayment = () => {
  ...
  const handlePhoneChange = (e) => {
    ...
    // If the value starts with '07', change it to '254'
    if (value.startsWith("07")) {
      value = "254" + value.slice(1);
    }

    // If the value starts with '+254', ensure it's correctly formatted
              ...
              <form onSubmit={submit}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    placeholder="254..."
                    value={phone}
                    onChange={handlePhoneChange} // Use the new handlePhoneChange
                    required
                  />
                </div>
